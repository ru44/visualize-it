...
export const SUBJECTS = ['algebra', 'functions', 'calculus', 'geometry', 'trigonometry', 'statistics', 'physics', 'waves', 'electricity', 'electromagnetism', 'aerodynamics', 'thermodynamics', 'chemistry', 'computer-science', 'biology', 'earth-space', 'economics', 'engineering', 'discrete', 'ai', 'numbers', 'data', 'quantum', 'relativity', 'cryptography', 'cosmos', 'nuclear'] as const
